...
const About = () => {
  const foundersInterns = [
    { name: 'Rajat', linkedin: 'https://www.linkedin.com/in/rajat-b92183207?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app', photo: '/interns/rajat.jpeg' },
    ...
    { name: 'Amey Dikshit', linkedin: 'https://www.linkedin.com/in/amey-dikshit-07157b284', photo: null }
  ];
  ...
  const devInterns = [
    ...
    { name: 'Pratyush Biswal', linkedin: 'https://www.linkedin.com/in/pratyush-biswal-289444163?utm_source=share_via&utm_content=profile&utm_medium=member_android', photo: '/interns/pratyush.jpeg' },
    ...
    { name: 'Shourya Mathur', linkedin: 'https://www.linkedin.com/in/shourya-mathur-56918221a?utm_source=share_via&utm_content=profile&utm_medium=member_ios', photo: '/interns/shourya.jpeg' },
